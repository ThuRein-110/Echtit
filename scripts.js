...
const translations = {
  en: {
    ...
    servicePriceLabel: "Monthly subscription",
    servicePrice: "$3/month",
    servicePriceNote: "Bring your own Tailscale. Each device must be installed with your permission.",
    serviceButton: "Ask for access",
  ...
  mm: {
    ...
    servicePriceLabel: "လစဉ် subscription",
    servicePrice: "$3/month",
    servicePriceNote: "ကိုယ်ပိုင် Tailscale လိုအပ်သည်။ Device တစ်ခုချင်းစီကို သင့်ခွင့်ပြုချက်ဖြင့် install လုပ်ရမည်။",
    serviceButton: "Access မေးရန်",
