...
const translations = {
  en: {
    ...
    heroCourseButton: "Course coming soon",
    heroWorkLink: "Selected work",
    metricCourse: "Course coming soon",
    ...
    courseAnnouncementLabel: "Course announcement",
    courseComingSoonValue: "Coming soon",
    courseComingSoonText: "Schedule and enrollment details will be announced soon.",
    deliveryLabel: "Delivery",
    paymentLabel: "Updates",
    paymentValue: "Telegram",
    courseButton: "Ask for updates",
    currentCourseEyebrow: "Course Announcement",
    ...
    courseAccessButton: "Ask for updates",
    ...
    servicePriceLabel: "One-time payment",
    servicePrice: "3000 THB",
    ...
    slipCheckText: "Access is approved only when the slip matches this TrueMoney account, exactly 3000 THB, and your name. Wrong or reused slips are denied.",
    copied: "Copied",
    ...
    contactText: "Course updates and questions via Telegram.",
  ...
  mm: {
    ...
    heroCourseButton: "မကြာမီလာမည့်သင်တန်း",
    heroWorkLink: "လက်ရာများ",
    metricCourse: "သင်တန်း မကြာမီလာမည်",
    metricWork: "လက်ရာ preview",
    metricDelivery: "Telegram",
    courseStatus: "မကြာမီလာမည်",
    courseEyebrow: "သင်တန်း",
    courseTitle: "Steganography & CTF",
    courseText: "Stego၊ forensics၊ CTF workflow နှင့် writeup။",
    courseAnnouncementLabel: "သင်တန်းကြေညာချက်",
    courseComingSoonValue: "မကြာမီလာမည်",
    courseComingSoonText: "အချိန်ဇယားနှင့် စာရင်းသွင်းရန် အသေးစိတ်ကို မကြာမီ ကြေညာပါမည်။",
    deliveryLabel: "ပို့ချမည့်နေရာ",
    paymentLabel: "Update",
    paymentValue: "Telegram",
    courseButton: "Update မေးရန်",
    currentCourseEyebrow: "သင်တန်းကြေညာချက်",
    courseSectionTitle: "Steganography & CTF.",
    ...
    courseAccessButton: "Update မေးရန်",
    moduleOneTitle: "File Inspection",
    ...
    servicePriceLabel: "တစ်ကြိမ် payment",
    servicePrice: "3000 THB",
    ...
    qrEyebrow: "Thai QR Payment",
    qrTitle: "3000 THB payment အတွက် TrueMoney ကို Scan လုပ်ပါ",
    ...
    openTrueMoneyLink: "3000 THB TrueMoney link ဖွင့်ရန်",
    ...
    slipCheckText: "Slip သည် ဤ TrueMoney account၊ 3000 THB အတိအကျ၊ နှင့် သင့်နာမည်တို့နှင့် ကိုက်ညီမှ access approve လုပ်ပါမည်။ မှားသော သို့မဟုတ် ပြန်သုံးထားသော slip များကို deny လုပ်ပါမည်။",
    ...
    contactText: "သင်တန်း update နှင့် မေးမြန်းမှုကို Telegram မှ။",
