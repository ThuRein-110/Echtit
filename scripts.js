...
const translations = {
  en: {
    ...
    qrText: "Tap the TrueMoney link or scan the QR, then upload your slip here. You do not need Telegram.",
  ...
  mm: {
    ...
    qrText: "TrueMoney link ကို နှိပ်ပါ သို့မဟုတ် QR ကို scan လုပ်ပါ၊ ပြီးနောက် slip ပုံကို ဒီမှာ upload လုပ်ပါ။ Telegram မလိုပါ။",
